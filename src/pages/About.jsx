    ...
    <>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 items-center ${isArabic ? "rtl" : ""}`}>
            <div>
              <SectionTitle
                title={t.story.title}
                ...
                centered={false}
              />
              <p className={`text-gray-700 mb-4 ${isArabic ? "font-arabic text-right" : ""}`}>
                {t.story.paragraph1}
              </p>
              <p className={`text-gray-700 mb-4 ${isArabic ? "font-arabic text-right" : ""}`}>
                {t.story.paragraph2}
            ...
            <div className="relative">
              <div className="rounded-lg shadow-lg w-full h-80 overflow-hidden">
                <img
                  src="/logo.png"
                  alt={isArabic ? "تأسيس الأكاديمية السعودية للتدريب الأمني" : "SSTA Foundation"}
                  className="w-full h-full object-contain object-center"
                />
              </div>

              <div className={`absolute -bottom-6 ${isArabic ? "-left-6" : "-right-6"} bg-ssta-gold text-ssta-dark p-4 rounded shadow-lg`}>
                <p className={`text-lg font-bold ${isArabic ? "font-arabic" : ""}`}>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <SectionTitle
            ...
            subtitle={isArabic ? "وضع معيار جديد للأمن السعودي" : "Setting a new standard for Saudi security"}
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
            <div className={`bg-white p-8 rounded-lg shadow-md ${isArabic ? "rtl" : ""}`}>
              ...
              <p className={`text-gray-700 ${isArabic ? "font-arabic text-right" : ""}`}>
            ...
            <div className="order-2 lg:order-1">
              <div className="rounded-lg shadow-lg w-full h-80 overflow-hidden">
                <img
                  ...
                  alt={isArabic ? "تميز في التدريب الأمني" : "Security Training Excellence"}
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className={`space-y-5 mt-6 ${isArabic ? "text-right" : ""}`}>
                <div className={`flex gap-4 ${isArabic ? "flex-row-reverse" : ""}`}>
                  ...
                  <div>
                    <h4 className={`text-lg font-bold text-ssta-dark mb-2 ${isArabic ? "font-arabic" : ""}`}>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
            <div className={`bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 ${isArabic ? "rtl" : ""}`}>
