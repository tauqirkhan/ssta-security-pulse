...
const Leadership = () => {
  ...
  const teamMemberTranslations = {
    major: {
      ...
      bio: `
        اللواء م. معيض الشهري هو شخصية مرموقة في قطاع الدفاع السعودي، يتمتع بخبرة عسكرية متميزة تمتد لأكثر من 35 عامًا. خلال مسيرته المهنية، شغل أدوارًا قيادية محورية، لا سيما منصبه كنائب قائد في أكاديمية الملك خالد العسكرية، حيث لعب دورًا حاسمًا في تشكيل الجيل القادم من الضباط العسكريين. تشمل خبرته الواسعة التخطيط الاستراتيجي، وأمن المعلومات، والقيادة التنظيمية. ساهم التزام اللواء الشهري بالتميز والابتكار بشكل كبير في تحديث وتطوير القوات المسلحة السعودية. بصفته الرئيس التنفيذي للأكاديمية السعودية للتدريب والتطوير الأمني (SSTA)، يستثمر اللواء الشهري خبرته الواسعة لتطوير مبادرات التدريب الأمني في المملكة. تحت قيادته، تكرس الأكاديمية جهودها لتعزيز قدرات المتخصصين في مجال الأمن، بما يتماشى مع أهداف رؤية المملكة ٢٠٣٠ لتعزيز الأمن الوطني وتشجيع الاعتماد على الذات تكنولوجيً
      `,
    },
    nawaf: {
      name: "نواف القحطاني",
      ...
      bio: `
         يعمل نواف القحطاني كمدير للشراكات في سعودي الأكاديمية السعودية للتدريب والتطوير الأمني (SSTA)، حيث يلعب دورًا محوريًا في تطوير قطاع الأمن الخاص في المملكة. بخلفيته القوية في المبيعات والتسويق وتطوير الأعمال، يتفوق نواف في بناء التحالفات الاستراتيجية وقيادة المبادرات التعاونية التي ترفع من مستوى معايير القطاع الأمني.
...
ولد ونشأ في المملكة المتحدة، يعيش سك الآن في الرياض، حيث كرس نفسه بالكامل لمستقبل المملكة. بإلهام من التحول السريع للمملكة العربية السعودية واعترافًا بالفجوات الحرجة في تطوير القوى العاملة، أسس سعودي الأكاديمية السعودية للتدريب والتطوير الأمني (SSTA) لإعادة تعريف المعايير الأمنية، ومؤسسة شفاء المستقبل الصحية لقيادة اتحاد من الأطباء المدربين في المملكة المتحدة يركزون على تطوير الرعاية الصحية من خلال تعزيز مهارات المواهب السعودية.
معروف بقدرته على دمج الخبرة العالمية مع الأولويات الوطنية، يتخصص صخ في بناء أنظمة بيئية هادفة تدفع النمو المستدام عبر الأمن والرعاية الصحية وما بعدها. يركز عمله على تمكين المواهب السعودية، وترسيخ أفضل الممارسات الدولية، وضمان توافق كل مشروع مع رؤية المملكة طويلة المدى للتميز والسيادة.
 ...
 في الأكاديمية السعودية للتدريب والتطوير الأمني، يقود سامراج التدريب العملي وضمان الجودة عبر جميع برامج الشهادات. يقود التدريبات الحية، والمحاكاة عالية الضغط، ويدرب المدربين السعوديين على الأداء بثقة تحت الضغط. كمتعاون طويل الأمد مع مارك برامويل، فهو يضمن أن كل دورة تقدم ليس فقط النظرية - بل الأداء الجاهز للميدان. يعد سامراج الفرق للحظات التي لا يكون فيها الفشل خيارًا.
      `,
    },
    tauqir: {
      name: "توقير خان",
      ...
      bio: `
        يجمع توقير خان بين مزيج فريد من الخبرة التقنية والفطنة التسويقية، ويتمتع بخبرة تزيد عن أربع سنوات في البرمجة إلى جانب خلفية قوية في المبيعات والتسويق. بصفته المسؤول التنفيذي للتسويق في الأكاديمية السعودية للتدريب والتطوير الأمني، يستفيد من عقليته التحليلية واستراتيجيته الإبداعية لتعزيز ظهور العلامة التجارية، ودفع المشاركة، ودعم أهداف نمو الأكاديمية في صناعة التدريب الأمني.
      `,
    },
    indy: {
      name: "إندي ناغرا",
      position: "رئيس قسم الحماية الشخصية",
      bio: `
        وذو خبرة عالية وُلد في لندن، يتمتع بخبرة دولية تزيد عن 20 عامًا في مجال الأمن الشخصي. تشمل مسيرته المهنية نشرات عملياتية في كل من العراق وأفغانستان مع الفوج السابع للمظلات بالجيش البريطاني (7th Parachute Regiment RHA)، بالإضافة إلى العمل مع وزارة الدفاع الأمريكية في الشرق الأوسط، وقطاع النفط والغاز، وأعضاء العائلات الملكية في الإمارات، والمشاهير، والرؤساء التنفيذيين للشركات.
يمتلك إندي خبرة مثبتة في الحماية الشخصية، والتدريب، ودمج فرق العمل الأمنية. في الآونة الأخيرة، قاد حماية شخصية لنخبة النجوم في مهرجان البحر الأحمر السينمائي، كما قدم خدمات أمنية خاصة للعملاء المهمين وذوي الثروات العالية في المملكة العربية السعودية.
      `
    }
  };
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
            <TeamMemberCard
              ...
              arabicBio="أندرو فوستر يتمتع بخبرة تزيد عن 25 عامًا في الخطوط الأمامية في المجالات العسكرية والأمنية الخاصة، بما في ذلك بما في ذلك 13 عامًا مع كتيبة المظلات الأولى، ويواصل الخدمة كاحتياطي نشط في الجيش. مدرب بدني مؤهل في الجيش، يلعب أيضًا الرجبي ويدربه، ويجلب نفس التركيز على العمل الجماعي والانضباط والقيادة إلى نهجه التدريبي. قام بتدريب وقيادة فرق في بيئات عالية المخاطر في العراق وأفغانستان وليبيا. يعتمد منهجه التدريبي على خبرة تشغيلية واسعة وأسس قوية من المؤهلات المهنية، مما يهيئ الضباط لأداء مهامهم بثقة وأخلاقية وفعالية في المواقف الواقعية"
...
He has trained and led teams in high-risk environments across Iraq, Afghanistan, and Libya. His instruction is built on extensive operational experience and a strong foundation of professional qualifications, preparing officers to perform confidently, ethically, and effectively in real-world situations.`}
            ...
            <TeamMemberCard
              ...
              arabicBio="بن ويلموت، بخلفية مميزة كقائد سابق في قوات المارينز الملكية، يجلب أكثر من 22 عامًا من الخبرة العملياتية في دوره كمدير تطوير الفرق. تمتد مسيرته المهنية عبر مجموعة واسعة من البيئات عالية المخاطر، حيث قدم خدمات استشارية أمنية حول العالم.
قدم الحماية الشخصية لكبار أفراد العائلات المالكة في أبوظبي وبروناي، وعمل كمستشار للأخطار العالية لوسائل الإعلام الكبرى أثناء تغطية الحرب بين إسرائيل وحماس، كما عمل مستشارًا لإدارة الأزمات لشركة جوجل في أوكرانيا، داعمًا سلامة الموظفين في بيئات معقدة.
كما عمل بن كضابط حماية دبلوماسية لوزارة الخارجية والكومنولث والتنمية البريطانية، ووزارة الخارجية والتجارة الأسترالية، وشركة بريتيش بتروليوم، وحلف الناتو، مع انتشار في كل من العراق وأوكرانيا. 
اليوم، يستند بن إلى هذه الخبرة الواسعة لتقديم تدريب عملي يركز على المهمة، مصمم خصيصًا ليناسب واقع العمليات الأمنية الحديثة."
...
Today, Ben draws on this extensive experience to deliver practical, mission-focused training tailored to the realities of modern security operations.`}
            ...
            <TeamMemberCard
              ...
              arabicPosition="مدرب"
              arabicBio="دارين كلاشير، مدرب ملتزم، يواصل تطوير خبراته ومهاراته يومًا بعد يوم. شغفه بالتعلم والتطوير يدفعه إلى تحسين أساليبه وتعزيز برامجه التدريبية. ومع اكتسابه المزيد من الخبرة، يظل دارين ملتزمًا بتقديم تعليم فعّال وجذاب وذو تأثير، يساهم في نمو ونجاح المتدربين."
