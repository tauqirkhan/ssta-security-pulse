...
const Sectors = () => {
  ...
  const featuredSectorDetails = {
    paragraph1: {
      ...
      ar: "تقدم سعودي سيكيوريتي ترينينغ آند أدفانسمنت برامج متخصصة للمسؤولين الأمنيين في المدن الذكية والمشاريع العملاقة مثل نيوم وذا لاين والقدية. تجمع هذه البرامج بين التكنولوجيا المتقدمة والأمن التقليدي لتلبية احتياجات هذه البيئات الحضرية الفريدة.",
    },
    paragraph2: {
