export const translations = {
  ...
  leadership: {
    ...
    ar: {
      ...
      visionSection: {
        ...
        paragraph1:
          "في الأكاديمية السعودية للتدريب والتطوير الأمني، نؤمن بأن الأمن فن استراتيجي يعتمد على القيادة التي تلهم الثقة وتبني النظم الفعالة والمستدامة. فريق قيادتنا هو مزيج متميز من الخبراء العسكريين والمهنيين المدنيين والمتخصصين السعوديين الذين يشكلون معًا مستقبل التدريب الأمني في المملكة. ",
        paragraph2: "بتوجيه من الرؤية الاستراتيجية للمؤسسين والخبرة العملية لكبار المدربين لدينا، نلتزم بتعزيز مواهب الجيل القادم من قادة الأمن السعوديين الذين سيقودون المملكة نحو مستقبل أكثر أمانًا وازدهارًا.",
        saudiFirst: {
      ...
      trainingTeam: {
        title: "فريق التدريب",
        subtitle:
          "يقدم مدربونا ومديرو برامجنا ذوو الخبرة خبراتهم الدولية في كل برنامج تدريبي.",
      },
      cta: {
  ...
  footer: {
    ...
    ar: {
      about:
        "الأكاديمية السعودية للتدريب والتطوير الأمني هي المعيار الجديد في التدريب الأمني السعودي",
  ...
  about: {
    ...
    ar: {
      ...
      story: {
        title: "قصتنا",
        subtitle:
          "تأسست الأكاديمية على مهمة لتحويل قطاع الأمن في المملكة العربية السعودية.",
        paragraph1:
          "تم إنشاء الأكاديمية السعودية للتدريب الأمني (SSTA) لتكون أول أكاديمية تدريب وتطوير أمني على مستوى عالمي في المملكة — بقيادة سعودية ومعززة بخبرة دولية رائدة.",
        paragraph2:
          "لقد أدركنا وجود فجوة كبيرة في السوق. على الرغم من أن المملكة العربية السعودية تضم أكثر من ٢٠٠,٠٠٠ متخصص في الأمن، إلا أن أقل من ٢٠٪ منهم حصلوا على مؤهلات رسمية أو تدريب منظم. تركز معظم شركات الأمن على القوى العاملة بدلاً من إنشاء مراكز للتميز.",
        paragraph3:
          "مهمتنا هي تحويل هذا المشهد، ودعم رؤية ٢٠٣٠ من خلال رفع مهارات المواطنين السعوديين والمساهمة في تطوير اقتصاد قائم على المعرفة."
      },
      mission: {
        title: "مهمتنا",
        description:
      ...
      difference: {
        title: "ما يميزنا",
        subtitle:
          "اختلاف الأكاديمية السعودية للتدريب والتطوير الأمني في التدريب",
        saudiLed: {
